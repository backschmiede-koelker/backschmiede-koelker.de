...
function AdminTile({
  ...
  return (
    ...
    >
      ...
      {/* Grid: default/lg = 1 Zeile; NUR md = 2 Zeilen */}
      <div
        className={[
      ...
      >
        ...
        {/* Content-Wrapper: default & lg block, md contents */}
        <div className="min-w-0 md:contents lg:block">
          ...
          {/* Untertitel: md in 2. Zeile über volle Breite */}
          <p
            className={[
  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-3.5 sm:px-6 md:px-8 py-6 md:py-10 min-w-0">
      ...
      <header className="mb-5 md:mb-8">
        {/* Grid statt flex: Button top-align mit Badge */}
        <div className="grid grid-cols-1 sm:grid-cols-[1fr,auto] gap-3">
          ...
          {/* Button: top-align (gleiche Höhe wie Badge), nie abgeschnitten */}
      ...
      {/* Tiles: 1 Spalte auf XS, 2 Spalten ab sm; etwas engeres Gap auf md */}
